...
public class EventResponsePaginationObj implements DataResponse {
	...
	public EventResponsePaginationObj(List<EventDto> content, int pageNo, int pageSize, long totalElements,
